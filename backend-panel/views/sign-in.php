...
if (isset($_POST['submit']) && !empty($_POST['email_id']) && !empty($_POST['pass_word'])) {

    $fun = new Functions();
    $sendArg = array();
    $email_id = $_POST['email_id'];
    $pass_word = $_POST['pass_word'];
    $User_login = $fun->validateLogin('users', $email_id, $pass_word);

    $User_login ? header("Location: " . SITE_ADMIN_URL . "") : "";
}
                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                        ...
                        <form action="<?php $_SERVER['PHP_SELF'] ?>" class="mt-4" method="POST">
                            ...
                            <div class="d-grid">
                                <button type="submit" class="btn btn-gray-800" name="submit">Sign in</button>
                            </div>
                        </form>
